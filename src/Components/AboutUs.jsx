...
const AboutUs = () => {
    return (
        <div>
            <div className='relative mt-20 space-y-5 lg:w-7/12  w-9/12  mx-auto flex flex-col items-center'>
                <h1 className='text-4xl font-semibold font-poppins z-10'>About SparkFund</h1>
                <div className='w-52 bg-amber-300 h-4 md:ml-32 rounded-sm absolute md:top-1 top-11 '></div>
