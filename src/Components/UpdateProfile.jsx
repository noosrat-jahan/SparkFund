...
const UpdateProfile = () => {
    ...
    return (
        <div className='card bg-base-100 mt-5 w-full mx-auto max-w-md shrink-0 shadow-lg border border-[#D0D0D0] "'>
            <h1 className='text-3xl font-semibold mb-4'>Update Profile Information</h1>
            <form onSubmit={handleUpdateProfile} className="card-body gap-3 p-1">
